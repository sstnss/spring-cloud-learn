...
public class Wrapper<T> implements Serializable {
	...
	public static <E> Wrapper<E> error() {
		return new Wrapper<E>(Wrapper.ERROR_CODE, Wrapper.ERROR_MESSAGE);
	}
	...
	public static <E> Wrapper<E> error(String message) {
		return new Wrapper<E>(Wrapper.ERROR_CODE, message==null ? Wrapper.ERROR_MESSAGE : message);
	}
	...
	public static <E> Wrapper<E> ok(E o) {
		return new Wrapper<E>(Wrapper.SUCCESS_CODE, Wrapper.SUCCESS_MESSAGE, o);
	}
